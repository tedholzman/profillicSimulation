...
)
{
  ...
  // TAH 11/11 reference sequan's begin and end explicitly
...
)
{
  ...
  //TAH 11/11 Reference seqan's begin and end explicitly
  ...
  // That's it.
  return;
} // gappedFastaAndConsensusToProfile( ProfuseTest::Parameters const &, Fasta<char> const &, String<char> const &, ProfileType & )
...
main ( int const argc, char const ** argv )
{
  ...
  galosh::ProfuseTest<ResidueType, floatrealspace, floatrealspace, floatrealspace, SequenceResidueType>::Parameters parameters;
